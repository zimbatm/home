...
## what
web2 deployed closure ≠ declared (origin/main@4afab0d).
...
health: running   secrets: active   failed: -   uptime: 2d13h44m
```
...
the want closure — CLI/gen-layer only. Diff below still current.
